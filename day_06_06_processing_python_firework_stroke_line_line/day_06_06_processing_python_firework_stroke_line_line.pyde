#day_06_06_processing_python_firework_stroke_line_line
#修改自day_06_05_processing_python_firework_mousePressed_fill_r_g_b
...
def draw():
    ...
    for i in range(N):
        ...
        #ellipse(x[i], y[i], 10, 10) 不想指畫圓，改成彩色線條
        stroke(r[i], g[i], b[i])
